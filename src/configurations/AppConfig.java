...
import hibernateClasses.Authorities;
...
@ComponentScans(value = { @ComponentScan("Mydaos"), @ComponentScan("services"), @ComponentScan("WSController") })
public class AppConfig {
  ...
  public LocalSessionFactoryBean getSessionFactory() {
    ...
    //get all hibernate class -> find an annotation for auto discover
    factoryBean.setHibernateProperties(props);
    factoryBean.setAnnotatedClasses(User.class, Authorities.class,
    		messages.class,machines.class,calendar.class);
