...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="./NSA/css/fullcalendar.min.css">
  <link rel="stylesheet" href="./NSA/css/fullcalendar.print.min.css" media="print">
  <!-- Theme style -->
...
<!-- jQuery UI 1.11.4 -->
<script src="./NSA/js/jquery-ui.min.js"></script>
<!-- Slimscroll -->
...
<!-- fullCalendar -->
<script src="./NSA/js/moment.js"></script>
<script src="./NSA/js/fullcalendar.min.js"></script>
...
<script src="./NSA/js2ws2/calendar.ws.js"></script>
    ...
    $('#calendar').fullCalendar({
      ...
      eventClick: function(calEvent, jsEvent, view) {
		console.log(calEvent.id);
          w.send("/app/calendar/delete/"+calEvent.id,{},{});
            $(this).remove();
      ...
      drop      : function (date, allDay) { // this function is called when something is dropped
        ...
        console.log(copiedEventObject);//create new date
        w.send("/app/calendar/new",{},JSON.stringify({title:copiedEventObject.title,d_Start:date,end:'none',bg:$(this).css('background-color')}));
        ...
        //w.save_event(date,allDay,$(this).css('background-color'))
